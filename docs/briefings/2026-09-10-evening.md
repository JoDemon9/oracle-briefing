...
> * **Αγορές & Tech:** Ήπια διόρθωση σε S&P 500 (-0,58%) & Nasdaq 100 (-1,08%). Στις μετοχές, πιέσεις σε TSMC (-1,68%) & NVIDIA (-2,37%), ενώ η Alphabet (+0,59%) και η Τράπεζα Κύπρου (+0,38%) σημείωσαν άνοδο.
> * **Κυπριακή Επικαιρότητα:** Παράταση μείωσης φόρου καυσίμων έως τέλη Νοεμβρίου και τετραμερής συμμαχία Κύπρου, Ελλάδας, Μάλτας & Ιταλίας για τη ναυτιλιακή ανταγωνιστικότητα.
...
| **Bitcoin (BTC/USD)** | $77.277,80 | -1,31% | Συσσώρευση στην περιοχή των $77k |
| **EUR/USD** | 1,1608 | -0,22% | Ελαφρά ενίσχυση δολαρίου ενόψει αποφάσεων ΕΚΤ |
| **EUR/GBP** | 0,8594 | +0,09% | Σταθεροποίηση εντός στενού εύρους διακύμανσης |
| **Bank of Cyprus (BOCH)** | €10,50 | +0,38% | Ισχυρό κλείσιμο σε υψηλό ημέρας στο ΧΑΚ/ΧΑ |
| **Brent Crude** | $102,42 | +1,20% | Εδραίωση πάνω από το ψυχολογικό όριο των $100 |
...
| **Alphabet (GOOG)** | $332,60 | +0,59% | Ανθεκτικότητα και ανοδική διαφοροποίηση στον κλάδο AI |
